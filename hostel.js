...
function triggerGoogleAuth() {
    if (!backendIsAvailable()) {
        showAlert('Google login needs a live backend. GitHub Pages is static, so deploy the backend separately or use the email/phone sign-in flow instead.', 'warning');
        return;
    }
